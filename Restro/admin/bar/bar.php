...
// Consulta para pedidos de bebida
$query = "SELECT 
...
<body>
  ...
  <div class="main-content">
    ...
    <!-- Header -->
    <div style="background-image: url(../assets/img/theme/bar-bg.jpg); background-size: cover;" class="header pb-8 pt-5 pt-md-8">
      <span class="mask bg-gradient-dark opacity-8"></span>
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h1 class="display-2 text-white">Bar</h1>
              <p class="text-white mb-0">Pedidos de bebida</p>
            </div>
    ...
    <div class="container-fluid mt--7">
      <?php if (empty($grupos)): ?>
        <div class="alert alert-info">No hay pedidos pendientes en bar.</div>
      <?php else: ?>
        <div class="row">
                  ...
                  <?php foreach ($grupo['pedidos'] as $pedido): ?>
                    <div class="list-group-item">
                      <div class="row align-items-center">
                        ...
                        <!-- Botones de acción -->
                        <div class="col-auto">
                          <form action="../bar/actualizar_estado_bar.php" method="post">
                            ...
                            <?php if ($pedido->order_status == 'Pendiente'): ?>
                              <button type="submit" name="estado" value="En preparación" class="btn btn-sm btn-info">
                                <i class="fas fa-glass-martini"></i> Preparar
                              </button>
                            <?php else: ?>
